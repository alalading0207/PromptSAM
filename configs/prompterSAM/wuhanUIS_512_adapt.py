'''6. Domain adaptation training config. Train on source(2022) + target(2005-2019) with prototypes/soft pseudo labels.'''
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-whu', group='rsprompter-query', name='adaprompterSAM'))
                ]
