'''5. Prototype computation config. Compute prototypes on WuhanUIS 0519 using source-trained model.'''
...
visualizer = dict(type='DetLocalVisualizer_adapt', vis_backends=vis_backends, name='visualizer',stage=stage)
...
# dataset 
dataset_type = 'WuhanUISDataset_0519'    
code_root = '/home/dyl/PromptSAM'
data_root = '/home/dyl/PromptSAM/data/wuhanUIS_0519'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=code_root + '/data/wuhanUIS_0519/annotations/wuhanUIS_0519_train.json',
