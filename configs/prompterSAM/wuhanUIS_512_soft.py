'''4. Soft label generation config. Generate pseudo labels on WuhanUIS 0519 using source-trained model.'''
...
visualizer = dict(
    type='DetLocalVisualizer_adapt', vis_backends=vis_backends, name='visualizer',stage=stage)
