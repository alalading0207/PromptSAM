'''1. Source domain training config. Train base model on WuhanUIS 2022 only.'''
...
default_hooks = dict(
    ...
    param_scheduler=dict(type='ParamSchedulerHook'),                     # save_best='coco/segm_mAP'
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-whu', group='rsprompter-query', name='prompterSAM'))
                ]
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=code_root + '/data/wuhanUIS_2022/annotations/wuhanUIS_2022_test.json',
